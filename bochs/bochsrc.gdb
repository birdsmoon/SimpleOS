...
plugin_ctrl: voodoo=false, extfpuirq=true, ne2k=false, es1370=false, pcidev=false, usb_uhci=false, usb_ohci=false, pcipnic=false, biosdev=true, gameport=true, busmouse=false, speaker=true, parallel=true, e1000=false, usb_ehci=false, iodebug=true, usb_xhci=false, sb16=false, unmapped=true, serial=true
